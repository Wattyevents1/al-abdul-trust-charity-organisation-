...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hope Africa Foundation is a humanitarian NGO bringing food, education, healthcare, clean water and hope to communities across Africa." },
      { author: "Hope Africa Foundation" },
